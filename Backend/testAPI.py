...
class APITester(unittest.TestCase):
    ...
    def test_validState_getEnergyByCategoryForState(self):
        ...
        self.assertEqual(result, {'Other renewables': 3031.96, 'Conventional hydroelectric': 2144.8900000000003, 'Nuclear': 9970.199999999999, 'Utility-scale photovoltaic': 366.82, 'All utility-scale solar': 366.82, 'All solar': 548.86, 'Wind': 1593.48})
